...
_How fast does the algorithm resolve collisions per second?_
...
_How well does performance hold as minion count increases?_
...
_How much CPU is consumed relative to the number of collisions being handled?_
...
_How consistent is FPS while the collision system is active?_
...
_How fast does the algorithm find paths?_
...
_How well does performance hold as path requests and map complexity increase?_
...
_How efficiently does the algorithm use CPU relative to paths resolved?_
...
_How consistent is FPS while pathfinding is active?_
